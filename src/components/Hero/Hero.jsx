			...
			<div className="container flex flex-col justify-center p-20 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-around bg-netural-content rounded-2xl shadow-lg">
				<div className="flex flex-col justify-center p-6 text-center rounded-sm  lg:text-left lg:w-6/12">
					...
					<p className="mt-6 lg:mb-6 sm:mb-12 text-xl text-gray-700">
						...
						<span class="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-accent relative inline-block ml-4">
							<span class="relative "> Programming Languages.</span>
						</span>
					</p>
					...
					<div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
						<a
							...
							href="#"
							className="font-semibold rounded btn btn-primary"
						>
							Start Quiz
						</a>
						<a
							rel="noopener noreferrer"
							href="#"
							className="font-semibold border rounded btn btn-outline btn-info"
						>
							Learn More
						</a>
					</div>
